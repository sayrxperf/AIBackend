# Library ac_ffb_postprocess

Documentation for ac_ffb_postprocess. Please note: documentation generator is in development and needs more work, so some information might be missing and other bits might not be fully accurate.
...
## Function ac.unlockFFBLimits(unlock)
...
for whatever reason unrestricted torque.
  ...
  1. `unlock`: `boolean?` Default value: `true`.
## Class ac.StateWheelPhysicsRate
## Class ac.StateCarPhysicsRate
## Class ScriptData
Note: joypad assist script runs from physics thread, so update rate is much higher. Please keep it in mind and keep
code as fast as possible.
## Function ac.disableLowSpeedFFBReduction(disable)

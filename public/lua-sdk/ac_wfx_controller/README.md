# Library ac_wfx_controller

Documentation for ac_wfx_controller. Please note: documentation generator is in development and needs more work, so some information might be missing and other bits might not be fully accurate.
...
`math.pi` if they are opposite. If real sun trajectory is disabled, returns `math.pi / 2`.
  ...
  - `number`
## Function ac.getInputWeatherType()

  Returns:

  - `ac.WeatherType`
## Function ac.getInputTemperatures()

  Returns:

  - `ac.TemperatureParams`
## Function ac.getInputWind()

  Returns:

  - `ac.WindParams`
## Function ac.getInputTrackState()

  Returns:

  - `ac.TrackConditions`
## Function ac.getInputHumidity(valuePresent)

  Parameters:

  1. `valuePresent`: `boolean|refbool|nil|nil` Default value: `nil`.

  Returns:

  - `number`
## Function ac.getInputPressure(valuePresent)
  ...
  - `number`
## Function ac.setConditionsSet(c)
...
follow the new system.
  ...
  1. `c`: `ac.ConditionsSet`
## Function ac.setConditionsSet2(c)
